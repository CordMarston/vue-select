...
const G = /* @__PURE__ */ S(J, [["render", Q]]), Z = {}, ee = {
  xmlns: "http://www.w3.org/2000/svg",
  width: "14",
  height: "10"
...
const oe = /* @__PURE__ */ S(Z, [["render", ie]]), T = {
  ...
  mounted(e, { instance: t }) {
    if (t.appendToBody) {
      ...
      let g = window.scrollX || window.pageXOffset, o = window.scrollY || window.pageYOffset;
...
https://vue-select.org/api/props.html#getoptionkey`, e, t);
  ...
  methods: {
    ...
    toggleDropdown(e) {
      ...
      this.actualWidth = l.toFixed(1);
      const i = e.target !== this.searchEl;
      i && e.preventDefault();
      const g = [
        ...this.deselectButtons || [],
        this.$refs.clearButton
      ];
      if (this.searchEl === void 0 || g.filter(Boolean).some((o) => o.contains(e.target) || o === e.target)) {
        e.preventDefault();
        return;
      }
      this.open && i ? this.searchEl.blur() : this.disabled || (this.open = !0, this.searchEl.focus());
    },
    isOptionSelected(e) {
  ...
  ref: "actions",
  class: "vs__actions"
}, ge = ["disabled"], ye = { class: "vs__spinner" }, me = ["id", "actualWidth"], be = ["id", "aria-selected", "onMouseover", "onClick"], _e = {
  key: 0,
  class: "vs__no-options"
}, Oe = /* @__PURE__ */ v(" Sorry, no matching options. "), we = ["id"];
function ve(e, t, s, n, l, i) {
  const g = K("append-to-body");
  return a(), h("div", {
    dir: s.dir,
    ...
    u("div", {
      ...
      u("div", ue, [
        ...
        r(e.$slots, "search", d(c(i.scope.search)), () => [
          u("input", k({ class: "vs__search" }, i.scope.search.attributes, $(i.scope.search.events)), null, 16)
        ])
      ], 512),
      u("div", fe, [
        w(u("button", {
      ...
      default: z(() => [
        i.dropdownOpen ? w((a(), h("ul", {
          ...
          (a(!0), h(B, null, L(i.filteredOptions, (o, p) => (a(), h("li", {
            ...
            onClick: P((y) => s.selectable(o) ? i.select(o) : null, ["prevent", "stop"])
          }, [
